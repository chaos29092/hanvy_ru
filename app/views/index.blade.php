...
<div class="container">
  <div id="container" class="clearfix">
    <nav class="col1-3 no-bg element home services clients portfolio about blog contact">
      ...
      <ul class="list check">
                 <li>22 лет опыта производства</li>
                 <li>10 лет опыта экспорта</li>
                 <li>Оптимизация программы </li>
                 <li>контейнерных перевозок</li>
                 <li>Конкуренто способность цены и качества</li>
                 <li>Опросной лист по закупк</li>
               </ul>
    ...
    <div class="element home clearfix col2-3 services">
               <div class="images"><img src="{{asset('img/canshu_1.jpg')}}" alt="" /></div>
    </div>

    <div class="element home clearfix col2-3 services">
               <div class="images"><img src="{{asset('img/canshu_2.jpg')}}" alt="" /></div>
    </div>
...
<p>Здравствуйте! Меня зовут Дима,<br/>
 я менеджер по продажам компании HANVY.</p><br/>
<p>Добро пожаловать на наш веб-сайт!</p><br/>
<p>Пожалуйста, добавьте мой Skype чтобы получить <br/>
 подробные информацию: vp20hanvyzj</p><br/>
</div>
</div>
